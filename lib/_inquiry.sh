...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do WztiChat que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador WztiChat APP, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar WztiChat APP\n"
  printf "   [1] Atualizar WztiChatP APP\n"
  printf "   [2] Deletar WztiChat APP\n"
  printf "   [3] Bloquear WztiChatP APP\n"
  printf "   [4] Desbloquear WztiChat APP\n"
  printf "   [5] Alter. dominio WztiChat APP\n"
  printf "\n"
  read -p "> " option
